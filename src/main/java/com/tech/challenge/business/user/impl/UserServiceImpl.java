package com.tech.challenge.business.user.impl;

import com.tech.challenge.business.user.UserService;
...
//        Boolean thing = userInfoRepository.existsByEmailAndPassword(email, password);
//
//        if(!userInfoRepository.existsByEmailAndPassword(email, password)){
//            return ResponseEntity
//                    .status(HttpStatus.UNAUTHORIZED)
//                    .body(new ErrorResponse("Solo se puede crear clientes con super usuario"));
//        }
